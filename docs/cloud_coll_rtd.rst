...
| <https://developers.google.com/earth-eng |                                                       |
| ine/datasets/catalog/COPERNICUS_S2_HARMO | reflectance.                                          |
| NIZED>`_                                 |                                                       |
+------------------------------------------+-------------------------------------------------------+
