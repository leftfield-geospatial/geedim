...
default_prop_schema = {
    ...
    'system:time_start': {
        'abbrev': 'DATE',
        'description': 'Image capture date/time (UTC)',
    },
    'FILL_PORTION': {
        'abbrev': 'FILL',
...
landsat_prop_schema = {
    **default_prop_schema,
    ...
    'GEOMETRIC_RMSE_MODEL': {
        'abbrev': 'GRMSE',
        'description': 'Orthorectification RMSE (m)',
    },
...
s2_prop_schema = {
    **default_prop_schema,
    ...
    'RADIOMETRIC_QUALITY': {
        'abbrev': 'RADQ',
        'description': 'Radiometric quality check',
    },
    'GEOMETRIC_QUALITY': {'abbrev': 'GEOMQ', 'description': 'Geometric quality check'},
    'MEAN_SOLAR_AZIMUTH_ANGLE': {
        'abbrev': 'SAA',
        'description': 'Solar azimuth angle (deg)',
    },
    'MEAN_SOLAR_ZENITH_ANGLE': {
        'abbrev': 'SZA',
        'description': 'Solar zenith angle (deg)',
    },
...
collection_schema = {
    ...
    'LANDSAT/LT04/C02/T1_L2': {
        ...
        'ee_url': 'https://developers.google.com/earth-engine/datasets/catalog'
        '/LANDSAT_LT04_C02_T1_L2',
    ...
    'COPERNICUS/S2_HARMONIZED': {
        ...
        'image_type': geedim.mask._Sentinel2ToaImage,
        'ee_url': 'https://developers.google.com/earth-engine/datasets/catalog'
        '/COPERNICUS_S2_HARMONIZED',
        'description': 'Harmonised Sentinel-2, level 1C, top of atmosphere '
        'reflectance.',
    },
    # 'MODIS/061/MCD43A4': {
